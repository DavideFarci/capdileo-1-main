export function validateReservation(resValues, max) {
  let errValid = [];
  // Giorno e ora
  ...
  } else if(resValues.n_persone > max[0]) {
    errValid.push("Il numero di persone richiesto non è disponibile per questa fascia orario");
